...
export default function TodoElement(outlet, data) {
  ...
  constructor.innerHTML = `
    ...
    <button name="deleteElement" class="p-4 flex justify-center items-center text-red-600 hover:bg-red-600 hover:text-white rounded-tr rounded-br outline-none">
